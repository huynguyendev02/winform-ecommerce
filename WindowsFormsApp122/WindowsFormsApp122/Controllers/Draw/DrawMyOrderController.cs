...
namespace WindowsFormsApp122.Controllers.Draw
{
    public class DrawMyOrderController
    {
        ...
        Label[] allLabel;
        int index, id;
        public DrawMyOrderController(int index, string stt, string date, string address, string supplier, string totalPrice, string status, int id) {
            this.index = index;
            this.stt.Text = stt;
            this.date.Text = date;
