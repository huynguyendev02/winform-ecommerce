...
namespace WindowsFormsApp122.FormFunction
{
    public class OrderFunction
    {
        ...
        public static List<dynamic> invoicesInfo(int user_id)
        {
            using (var context = new DatabaseEC())
            {
                var query = context.order_details.Where(o => o.users_id == user_id && o.payment_details.statuss == "Completed").Select(o => new { o.id, o.total, o.payment_details.statuss, o.created_at, o.payment_details.providers, o.user.first_name, payTime =  o.payment_details.created_at });
                return query.ToList<dynamic>();
            }
        }
